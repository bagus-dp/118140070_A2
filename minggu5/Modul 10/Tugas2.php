...
<body>
    ...
    <ul id="ul">
        <li id="1">Jersey | <a onclick="mEdit('1')">Edit</a> | <a onclick="mHapus(1)">Hapus</a></li>
        <li id="2">Bola Futsal | <a onclick="mEdit('2')">Edit</a> | <a onclick="mHapus(2)">Hapus</a></li>
        <li id="3">Sepatu Futsal | <a onclick="mEdit('3')">Edit</a> | <a onclick="mHapus(3)">Hapus</a></li>
    </ul>
</body>
<script>
